...
export function OperationFilters({ status = '', cliente = '', search = '', uniqueClients }: OperationFiltersProps) {
  ...
  return (
    <form method="GET" action="/dashboard/operacoes" className="grid min-w-0 gap-2 rounded-md border border-[#deded9] bg-white p-3 md:grid-cols-[minmax(180px,1fr)_160px_180px_auto]">
